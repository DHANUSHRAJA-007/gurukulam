...
class _LoginBodyState extends State<_LoginBody> {
  ...
  Widget build(BuildContext context) {
    return Consumer<LoginViewModel>(
      builder: (context, viewModel, child) {
        _listenForErrors(context, viewModel);
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        ...
                        blurRadius: 52.91,
                        offset: const Offset(3.666, 4.888),
                      ),
                    ],
                  ),
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // =================================
                        SizedBox(
                          width: screenWidth.clamp(200.0, 280.0),
  ...
  void _listenForErrors(BuildContext context, LoginViewModel viewModel) {
